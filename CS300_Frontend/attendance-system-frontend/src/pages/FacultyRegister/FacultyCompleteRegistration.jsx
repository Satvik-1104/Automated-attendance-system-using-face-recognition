// src/pages/FacultyRegister/FacultyCompleteRegistration.jsx
import React, { useState } from "react";
import axios from "axios";

const BASE_URL = import.meta.env.VITE_BACKEND_URL;
const FacultyCompleteRegistration = ({ facultyId, email, onSubmit }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/faculty/register`, {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Complete Faculty Registration</h2>
      <input
        style={styles.input}
...
export default FacultyCompleteRegistration;